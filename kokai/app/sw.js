...
self.addEventListener('fetch', (event) => {
  ...
  // Opening the app at any address within its scope, such as with a screen in the hash, serves the page.
